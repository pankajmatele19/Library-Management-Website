...
public final class dispbook_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 String name = (String) session.getAttribute("username"); 
      ...
      out.write("                        <h3 class=\"page-title\"> Manage Books </h3>\n");
      out.write("                        <nav aria-label=\"breadcrumb\">\n");
      out.write("                            <ol class=\"breadcrumb\">\n");
      out.write("                                <li class=\"breadcrumb-item\"><a href=\"#\">Forms</a></li>\n");
      out.write("                                <li class=\"breadcrumb-item active\" aria-current=\"page\">Manage Books</li>\n");
      out.write("                            </ol>\n");
      out.write("                        </nav>\n");
      out.write("                    </div>\n");
      ...
      out.write("                                <h4 class=\"card-title\">Books</h4>\n");
      out.write("                                </p>\n");
      ...
      out.write("                                       ");
                                    ...
                                    try {
                                        ...
                                        String sql = "{call ADBMSproject.dispbooks(?,?,?,?,?,?)}";
...
//                                            out.println("<tr><td>" + bid + "</td><td>" + name + "</td><td>" + Author + "</td><td>" + quan + "</td><td>" + dept + "</td><td>" + "<a href='upbook.jsp?bid=" +bid+ "&q=" + quan + "'><button class='btn btn-primary'>Update</button></a>" + "</td><td>" + "<a href='delbook.jsp?bookid=" + bid + "'><button class='btn btn-danger'>Delete</button></a>" + "</td><tr>");
                        out.println("<tr><td>" + bid + "</td><td>" + na + "</td><td>" + Author + "</td><td>" + quan + "</td><td>" + dept + "</td><td>" + "<a href='upbook.jsp?bid=" +bid+ "&q=" + quan + "'><button class='btn btn-primary'>Update</button></a>" + "   " + "<a href='delbook.jsp?bookid=" + bid + "'><button class='btn btn-danger'>Delete</button></a>" + "</td><tr>");
