      ...
      <ul class="nav">
        ...
        <li class="nav-item menu-items">
          ...
          <div class="collapse" id="ui-basic1">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="addbook.html">Add Books</a></li>
        ...
        <li class="nav-item menu-items">
          ...
          <div class="collapse" id="ui-basic3">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="addissue.html">Add Issue</a></li>
        ...
        <li class="nav-item menu-items">
          ...
          <div class="collapse" id="ui-basic4">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="addfine.html">Add Fine</a></li>
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="addissue.jsp"> 
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputUsername1" name="uid" placeholder="user id">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Book Id</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" name="bid" placeholder="book id">
                    </div>
                    <div class="form-group">
