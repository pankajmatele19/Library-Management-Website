                                ...
                                <div class="table-responsive">
                                  <table class="table">
                                    ...
                                    try {
                                        ...
                                        String sql = "{call ADBMSproject.dispfine(?,?,?,?,?,?,?,?)}";
                                        ...
                                        while (rs.next()) {
                                            ...
                                            out.println("<tr><td>" + fid + "</td><td>" + uid + "</td><td>" + n + "</td><td>" + bid + "</td><td>" + rtd + "</td><td>" + d + "</td><td>" + f + "</td><td>" + "<a href='delfine.jsp?fid=" +fid+ "'><button class='btn btn-danger'>Delete</button></a>" + "</td><tr>");
                                        }
                                    } catch (Exception e) {
