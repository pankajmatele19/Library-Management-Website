                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="addfine.jsp">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputUsername1" name="uid" placeholder="uid">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Book Id</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" name="bid" placeholder="bid">
                    </div>
                    <div class="form-group">
